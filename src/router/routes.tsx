...
const Contacts = lazy(() => import('../pages/poker/admin/systemManager/UserAdmin'));
...
const Blog = lazy(() => import('../pages/poker/admin/blog'));
...
const routes = [
    ...
    {
        path: '/admin/premiumSetter',
        element: <PremiumSetting />,
    },
    {
